...
def format_conversation(item, tokenizer, conversation_key: str, tool_key: str):
    ...
    _update([tokenizer.eos_token_id], True)
...
class MultiTurnDataset(Dataset):
    ...
    def __getitem__(self, i) -> dict:
        ...
        tokens, loss_masks = format_conversation(data_item, self.tokenizer, CONVERSATION_KEY, TOOL_DESC_KEY)
...
def get_dataset(data_args, tokenizer):
    with open(data_args.train_data_path, "r", encoding="utf-8") as f:
